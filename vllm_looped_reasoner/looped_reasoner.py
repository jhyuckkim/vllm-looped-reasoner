...
class LoopedReasonerAttention(nn.Module):
    def __init__(
        self,
        ...
        self.rotary_emb = get_rope(
            ...
            base=config.rope_parameters["rope_theta"] if config.rope_parameters else 1000000, # COMMENT OUT for next vllm release
            # rope_parameters=config.rope_parameters, UNCOMMENT for next vllm release
...
class LoopedReasonerDecoderLayer(nn.Module):
    def __init__(
        self,
        config: PretrainedConfig,
        cache_config: CacheConfig | None = None,
        ...
        self.self_attn = LoopedReasonerAttention(
            config=config,
...
class LoopedReasonerModel(Qwen2Model):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super().__init__(
            vllm_config=vllm_config, prefix=prefix, decoder_layer_type=LoopedReasonerDecoderLayer
        )
        self.early_exit_gate = RowParallelLinear(self.config.hidden_size, 1, bias=True)
...
class LoopedReasonerForCausalLM(nn.Module, SupportsLoRA):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.model = LoopedReasonerModel(
